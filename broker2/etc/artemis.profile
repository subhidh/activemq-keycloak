...
ARTEMIS_HOME='/Users/subhidh/Documents/apache-artemis-2.28.0'
ARTEMIS_INSTANCE='/Users/subhidh/Desktop/artemis/var/lib/broker2'
ARTEMIS_DATA_DIR='/Users/subhidh/Desktop/artemis/var/lib/broker2/data'
ARTEMIS_ETC_DIR='/Users/subhidh/Desktop/artemis/var/lib/broker2/etc'
ARTEMIS_OOME_DUMP='/Users/subhidh/Desktop/artemis/var/lib/broker2/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/Users/subhidh/Desktop/artemis/var/lib/broker2/'
ARTEMIS_INSTANCE_ETC_URI='file:/Users/subhidh/Desktop/artemis/var/lib/broker2/etc/'
...
# Java Opts
if [ -z "$JAVA_ARGS" ]; then
    JAVA_ARGS="-XX:AutoBoxCacheMax=20000 -XX:+PrintClassHistogram -XX:+UseG1GC -XX:+UseStringDeduplication -Dhawtio.disableProxy=true -Dhawtio.realm=console -Dhawtio.realm=activemq -Dhawtio.offline=true -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml -Dhawtio.keycloakEnabled=true -Dhawtio.keycloakClientConfig=${ARTEMIS_INSTANCE_ETC_URI}keycloak-js-client.json -Dhawtio.authenticationEnabled=true -Djavax.net.ssl.trustStore=/Users/subhidh/Desktop/ssl/server-ca-truststore.jks -Djavax.net.ssl.trustStorePassword=securepass"
fi
